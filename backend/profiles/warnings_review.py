"""
Warnings Review profile — RxNorm → DailyMed.
"""
...
async def run(medication_name: str) -> MedicationEvidence:
    ...
    Gemini reads label_evidence.boxed_warnings and label_evidence.precautions.
    ...
    return MedicationEvidence(
        profile_used=ProfileType.WARNINGS_REVIEW,
