        ...
        {steps.map((step, index) => (
          ...
          >
            <div className="flex items-center gap-3">
              <motion.span
                animate={step.pending ? { scale: [1, 1.08, 1], opacity: [0.65, 1, 0.65] } : { scale: 1 }}
                transition={{ repeat: step.pending ? Infinity : 0, duration: 1.6 }}
              ...
              >
                {step.pending ? <Circle size={14} fill="currentColor" /> : <Check size={17} />}
              </motion.span>
